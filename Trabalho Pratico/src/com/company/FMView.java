...
*/
    ...
    public static void displayJogadas(String bolaAntes, String bolaDepois, int result, String casa, String fora){
        ...
        String[] cantoCasaParaPBC = {"E vai remateeee.... Foi para foraaa...","O homem chutaaaa...e falhaaa","A bola vai entrar.. vai entrar... mas não entrou! Ponta pé de baliza para "+ casa + "!"};
